...
- (void)customizeApp {
    ...
    UIColor *tintColor = [UIColor colorFromHexCode:@"FF4100"];
    ...
    [tabBarAppearance setSelectedImageTintColor:tintColor];
...
{
    [[NSNotificationCenter defaultCenter] postNotificationName:@"handleseen" object:nil];
